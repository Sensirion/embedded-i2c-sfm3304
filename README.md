# Sensirion I2C SFM3304 embedded Library

This document explains how to set up a SFM3304 sensor to run on an embedded device using the I²C interface.
...
Your sensor has 4 pins that need to be connected to your board: VDD, SCL, GND, SDA.
Use the following description to connect your SFM3304:
...
5. Run the compiled executable with `./sfm3304_i2c_example_usage`
...
5. Run the compiled executable with `./sfm3304_test_hw_i2c`.
